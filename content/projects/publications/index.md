...
- **Shotaro Ishihara**, Hiromu Takahashi, and Hono Shirai (2023). Quantifying Diachronic Language Change via Word Embeddings: Analysis of Social Events using 11 Years News Articles in Japanese and English. 9th International Conference on Computational Social Science. [[abstract](https://upura.github.io/pdf/ic2s2_2023_semantic_shift.pdf) ] [[poster](https://speakerdeck.com/upura/quantifying-diachronic-language-change-via-word-embeddings-analysis-of-social-events-using-11-years-news-articles-in-japanese-and-english) ]
- **Shotaro Ishihara** (2023). Training Data Extraction From Pre-trained Language Models: A Survey. Proceedings of Third Workshop on Trustworthy Natural Language Processing. (to appear) [[arXiv](https://arxiv.org/abs/2305.16157) ] [[poster](https://speakerdeck.com/upura/training-data-extraction-from-pre-trained-language-models-a-survey) ]
