...
- News summarization ([Journal of NLP](https://doi.org/10.5715/jnlp.31.1717))
- Entity linking system ([Journal of NLP](https://doi.org/10.5715/jnlp.31.1330))
...
- Quantifying memorization of LLMs
    - Survey paper ([ACL 2023 Workshop](https://aclanthology.org/2023.trustnlp-1.23/), Transactions of JSAI)
    ...
    - Monitoring time-series performance degradation ([AACL-IJCNLP 2022](https://aclanthology.org/2022.aacl-main.17/) & [Journal of NLP](https://doi.org/10.5715/jnlp.31.1563))
    - Experiments on Japanese newspaper ([INLG 2024](https://aclanthology.org/2024.inlg-main.14/), [ACL 2025 Workshop](https://aclanthology.org/2025.l2m2-1.8/))
- Hallucination analysis ([Journal of NLP](https://doi.org/10.5715/jnlp.31.1717))
